...
import 'package:tour_quest/Activity/Activity_places.dart';
              ...
              Center(
                child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    ...
                    Text("Famous",style: TextStyle(fontSize: 20,color: Colors.blue),),
                  ],
                ),
              ),
              SizedBox(),
            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: ListView(
                    children: [
                      Text("Palaces",style: TextStyle(fontSize: 20,color: Colors.blue),),
                      GestureDetector(
                        onTap: (){ Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> Activity_place()));},
                        child: Container(
